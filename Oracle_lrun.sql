...
column TIME_REMAINING format 99999999.999
select sid, round((sofar/totalwork*100),2) Percent, message, start_time, last_update_time, (time_remaining/60) TIME_REMAINING
